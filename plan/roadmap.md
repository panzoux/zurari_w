...
| ffmpeg と Explorer サムネイルの速度実測(2026-09-12、実ファイル 6本 849MB〜1.4GB) | ffmpeg が 6/6 で速い(205-624ms 対 282-722ms)。「外部ツール無しの方が安い」という 6c.5 の前提は崩れた — 順序は要再検討。詳細と注意点は phase6 の 6c.7 |
